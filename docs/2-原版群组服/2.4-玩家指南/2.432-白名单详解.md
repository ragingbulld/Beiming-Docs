...
mcs 执行 velocity multilogin whitelist add id//无论正版还是littleskin都是这个指令

mcs 执行 velocity multilogin whitelist remove id//移除白名单

multilogin whitelist specific add 0 id//正版白名单

multilogin whitelist specific add 2 id//littleskin白名单
...
审核群的诸位管理皆有白名单添加/移除权限，请谨慎使用，详情参考[北冥生电服服规](/2-原版群组服/2.2-生电服服规.md)
